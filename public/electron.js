        ...
        if (req.body.url) {
            if (!authWindow) {
                ...
                authWindow.webContents.on('did-navigate', (event, url) => {
                    ...
                    if (url.startsWith(authPattern)) {
                        authWindow.open(pattern);
                    }
